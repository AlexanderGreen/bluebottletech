<?php 
$your_email ='info@bluebottletech.com';// <<=== update to your email address
...
if(isset($_POST['submit']))
{
	...
	// strcmp()
		$errors .= "\n <p class='err'> The captcha code does not match!</p>";
	}
	...
	if(empty($errors))
	{
		...
		echo "<script>alert(' Thank you for contacting us. We will be in touch very soon.'); 
...
<div class="wrap">
    ...
    <div class="page">
    	<h1><strong>CONTACT</strong></h1>
        	<div class="block">
                <form method="POST" style="max-width:400px;" name="contact_form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>"> 
                <p>
                ...
                <input style="margin-left:140px;" type="submit" value="Submit" name='submit'>
                </form>
            </div><!--/block-->
            <div class="block">
